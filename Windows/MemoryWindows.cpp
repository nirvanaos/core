...
UWord MemoryWindows::check_allocated (Page* begin, Page* end)
{
	assert (begin);
	assert (end);
...
void MemoryWindows::copy_one_line (Octet* dst_begin, Octet* src_begin, UWord size, UWord flags)
{
	assert (src_begin);
	assert (dst_begin);
...
bool MemoryWindows::copy_one_line_aligned (Octet* dst_begin, Octet* src_begin, UWord size, UWord flags)
{
...
void MemoryWindows::commit (Page* begin, Page* end, UWord zero_init)
{
	assert (begin);
	assert (end);
	assert (begin < end);
...
void MemoryWindows::map_in_fiber (MapParam* param)
{
...
void MemoryWindows::stack_prepare (const ShareStackParam* param_ptr)
{
