...
{
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_get_servant), 3, nullptr);
	_call->invoke ();
	check_request (_call);
...
void Proxy <PortableServer::POA>::__rq_get_servant (PortableServer::POA* _servant,
	IORequest::_ptr_type _call)
{
	...
	Object::_ref_type ret;
	{
		...
		Type <Object>::C_ret _ret (
			(_servant->_epv ().epv.get_servant) (_servant, &_env));
		_env.check ();
		ret = _ret;
	}
	// Marshal output
...
{
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_set_servant), 3, nullptr);
...
void Proxy <PortableServer::POA>::__rq_set_servant (
	PortableServer::POA* _servant, IORequest::_ptr_type _call)
{
	...
	{
		Environment _env;
			(_servant->_epv ().epv.set_servant) (_servant,
...
PortableServer::ObjectId Proxy <PortableServer::POA>::activate_object (PortableServer::Servant p_servant) const
{
	...
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_activate_object), 3, nullptr);
	...
	PortableServer::POA* _servant, IORequest::_ptr_type _call)
{
	...
	PortableServer::ObjectId ret;
	{
		...
		Type <PortableServer::ObjectId>::C_ret _ret = 
			(_servant->_epv ().epv.activate_object) (_servant,
				&Type <Object>::C_in (p_servant),
				&_env);
		_env.check ();
		ret = _ret;
...
{
	Object::_ptr_type proxy = Core::servant2object (p_servant);
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_activate_object_with_id), 3, nullptr);
	...
	PortableServer::POA* _servant, IORequest::_ptr_type _call)
{
	...
	{
		Environment _env;
		(_servant->_epv ().epv.activate_object_with_id) (_servant,
...
{
	Object::_ptr_type proxy = Core::servant2object (p_servant);
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_servant_to_id), 3, nullptr);
	Type <Object>::marshal_in (proxy, _call);
	_call->invoke ();
	check_request (_call);
	PortableServer::ObjectId _ret;
	...
	PortableServer::POA* _servant, IORequest::_ptr_type _call)
{
	...
	PortableServer::ObjectId ret;
	{
		Environment _env;
		Type <PortableServer::ObjectId>::C_ret _ret =
			(_servant->_epv ().epv.servant_to_id) (_servant,
				&Type <Object>::C_in (p_servant),
				&_env);
		_env.check ();
		ret = _ret;
...
{
	Object::_ptr_type proxy = Core::servant2object (p_servant);
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_servant_to_reference), 3, nullptr);
	Type <Object>::marshal_in (proxy, _call);
	_call->invoke ();
	check_request (_call);
	Object::_ref_type _ret;
	...
	PortableServer::POA* _servant, IORequest::_ptr_type _call)
{
	...
	Object::_ref_type ret;
	{
		Environment _env;
		Type <Object>::C_ret _ret =
			(_servant->_epv ().epv.servant_to_reference) (_servant,
				&Type <Object>::C_in (p_servant),
				&_env);
		_env.check ();
		ret = _ret;
...
{
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_reference_to_servant), 3, nullptr);
	...
	PortableServer::POA* _servant, IORequest::_ptr_type _call)
{
	...
	Object::_ref_type ret;
	{
		Environment _env;
		Type <Object>::C_ret _ret =
			(_servant->_epv ().epv.reference_to_servant) (_servant,
...
{
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_id_to_servant), 3, nullptr);
	Type <PortableServer::ObjectId>::marshal_in (oid, _call);
	_call->invoke ();
	check_request (_call);
	Object::_ref_type _ret;
	...
	PortableServer::POA* _servant, IORequest::_ptr_type _call)
{
	...
	Object::_ref_type ret;
	{
		Environment _env;
		Type <Object>::C_ret _ret =
			(_servant->_epv ().epv.id_to_servant) (_servant,
				&Type <PortableServer::ObjectId>::C_in (oid),
				&_env);
		_env.check ();
		ret = _ret;
...
{
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_incarnate), 3, nullptr);
	Type <PortableServer::ObjectId>::marshal_in (oid, _call);
...
void Proxy <PortableServer::ServantActivator>::__rq_incarnate (
	PortableServer::ServantActivator* _servant, IORequest::_ptr_type _call)
{
	PortableServer::ObjectId oid;
	Type <PortableServer::ObjectId>::unmarshal (_call, oid);
...
{
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_etherealize), 3, nullptr);
	Type <PortableServer::ObjectId>::marshal_in (oid, _call);
	Type <PortableServer::POA>::marshal_in (adapter, _call);
...
{
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_preinvoke), 3, nullptr);
	Type <PortableServer::ObjectId>::marshal_in (oid, _call);
	Type <PortableServer::POA>::marshal_in (adapter, _call);
...
void Proxy <PortableServer::ServantLocator>::__rq_preinvoke (
	PortableServer::ServantLocator* _servant, IORequest::_ptr_type _call)
{
	PortableServer::ObjectId oid;
	Type <PortableServer::ObjectId>::unmarshal (_call, oid);
	PortableServer::POA::_ref_type adapter;
...
void Proxy <PortableServer::ServantLocator>::postinvoke (
	...
	PortableServer::ServantLocator::Cookie the_cookie, Object::_ptr_type the_servant) const
{
	IORequest::_ref_type _call = _target ()->create_request (_make_op_idx (__OPIDX_postinvoke), 3, nullptr);
	Type <PortableServer::ObjectId>::marshal_in (oid, _call);
	Type <PortableServer::POA>::marshal_in (adapter, _call);
	Type <Identifier>::marshal_in (operation, _call);
	_call->marshal (alignof (PortableServer::ServantLocator::Cookie),
		sizeof (PortableServer::ServantLocator::Cookie), &the_cookie);
	Type <Object>::marshal_in (the_servant, _call);
	_call->invoke ();
	check_request (_call);
	_call->unmarshal_end ();
}
	...
	PortableServer::ServantLocator* _servant, IORequest::_ptr_type _call)
{
	...
	_call->unmarshal (alignof (PortableServer::ServantLocator::Cookie),
		sizeof (PortableServer::ServantLocator::Cookie), &the_cookie);
	Object::_ref_type the_servant;
	Type <Object>::unmarshal (_call, the_servant);
	_call->unmarshal_end ();
