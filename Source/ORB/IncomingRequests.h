...
{
	static const unsigned SKIP_LIST_LEVELS = Nirvana::Core::INCOMING_REQUEST_SKIP_LIST_LEVELS;
...
public:
	...
	struct RequestVal : RequestKey
	{
		...
		uint64_t timestamp;
		servant_reference <RequestIn> request;
	};
	...
	static void receive (servant_reference <RequestIn> rq, uint64_t timestamp);
